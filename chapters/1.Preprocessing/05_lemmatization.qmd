...
Did you notice the new column added to the `tokens_nostop` data frame? If you haven’t yet, take a moment to check it out. It shows how some words have been converted to their dictionary or base forms.fixme: enter With that done, we can finally move on to the next chapter. But first, as a last step, we will save the file:
