...
![](chapters/1.Preprocessing/images/lemma-results.png)

With that done, we can finally move on to the next chapter. But first, as a last step, we will save the file:
